...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        AgentSentOrder::class=>[
            AgentSentOrderHook::class
        ],
        AdminApprovedOrder::class=>[
            AdminApprovedOrderHook::class
        ],
        AdminCompletedOrder::class=>[
            AdminCompletedOrderHook::class
        ],
        AdminUpdateOrder::class=>[
            AdminUpdateOrderHook::class
        ]
