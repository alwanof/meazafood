                ...
                <div class="card-body p-0 table-responsive">
                    <table class="table table-striped table-hover table-head-fixed">
                        ...
                        <tr v-for="(order,index) in orders.data" :key="order.id">
                            ...
                            <td width="10%">
                                <a  v-show="acl.admin_edit_pending_order" :href="path+'/admin/order/update/pending/'+order.id"
                                    type="button"
                                    class="btn btn-sm btn-info text-white"
                                >
                                    <i class="fa fa-edit"></i>
                                </a>
                                <button v-show="acl.admin_delete_pending_order" type="button" class="btn btn-sm btn-danger" @click="removeProduct(order)">
...
<script>
    ...
    export default {
        name: "PendingOrdersComponent.vue",
