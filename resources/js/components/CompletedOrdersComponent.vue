                ...
                <div class="card-body p-0 table-responsive">
                    <table class="table table-striped table-hover table-head-fixed">
                        ...
                        <tr v-for="(order,index) in orders.data" :key="order.id">
                            ...
                            <td>
                                <a v-show="acl.admin_edit_completed_order" :href="path+'/admin/order/update/completed/'+order.id"
                                    type="button"
                                    class="btn btn-sm btn-info text-white btn-block"
                                >
                                    <i class="fa fa-edit"></i>
                                </a>
                                <button v-show="acl.admin_delete_completed_order" type="button" class="btn btn-sm btn-danger btn-block" @click="removeProduct(order)">
...
<script>
    ...
    export default {
        name: "CompletedOrdersComponent.vue",
