...
<head>
  ...
  <title>Meaza Food - @yield('title')</title>
                ...
                @can('access_orders')
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('access_draft_orders')
                            <li class="nav-item">
                                <a href="{{route('orders.index')}}" class="nav-link ">
                                    <i class="fa fa-drafting-compass nav-icon"></i>
                                    <p>{{ __('orders.draft_orders') }}</p>
                                </a>
                            </li>
                            @endcan

                            @can('access_pending_orders')
                                <li class="nav-item">
                                    <a href="{{route('orders.pending')}}" class="nav-link ">
                                        <i class="fa fa-won-sign nav-icon"></i>
                                        <p>{{ __('orders.pending_orders') }}</p>
                                    </a>
                                </li>
                            @endcan
                            @can('access_approved_orders')
                                <li class="nav-item">
                                    <a href="{{route('orders.approved')}}" class="nav-link ">
                                        <i class="fa fa-check nav-icon"></i>
                                        <p>{{ __('orders.approved_orders') }}</p>
                                    </a>
                                </li>
                            @endcan
                            @can('access_completed_orders')
                                <li class="nav-item">
                                    <a href="{{route('orders.completed')}}" class="nav-link ">
                                        <i class="fa fa-shopping-basket nav-icon"></i>
                                        <p>{{ __('orders.completed_orders') }}</p>
                                    </a>
                                </li>
                            @endcan
                        </ul>
